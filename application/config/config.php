...
|
*/
// $config['base_url']  = "http://chao.local:8888/dayabay/";
...
// set up auto base url
$config['base_url'] = $http_host . str_replace(basename($_SERVER['SCRIPT_NAME']),"",$_SERVER['SCRIPT_NAME']);
