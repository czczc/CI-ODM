...
<div id="content">    
    ...
    <div id="fig_display" style="margin: 10px 0 10px 0">
     ...
     <div class = "left">
         ...
         foreach ($runlist as $run) {
             // echo $run;
             // $current_thousands = floor($run/1000);
             
             // echo $current_thousands;
             while (floor($run/1000) < $current_thousands) {
             ...
             echo '<td>';
             echo anchor('dybdb/findrun/' . $run . '/sim#diagnostics', sprintf('%05d', $run));
             echo '</td>';
             $column_index++;
 ...
 <script type="text/javascript" src="<?php echo(base_url() . "js/search_sim.js")?>"></script>
